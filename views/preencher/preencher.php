...
<body>  
    ...
    <form action="../../funcoes/gravar-dadosOR.php" method="post" id="formulario">
        ...
        <div class="atividades">
            ...
            <textarea name="periodo" id="periodo"maxlength="700"> <?php echo $lista['periodo'];?></textarea></div>
...
<div class="nd">
<img src="../form/marcadagua1.png" alt="" id="minhaimagem" >
<img src="../form/marcadagua2.png" alt="" id="minhaimagem2" >
</div>
