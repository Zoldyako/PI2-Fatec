...
<body>  
    ...
    <form action="gravardadosOR.php" method="post" id="formulario">
        ...
        <div class="empresa">
            ...
            <input required type="text" name="nomeempresa" id="nomeempresa" value="<?php echo $lista['nomeempresa'];?>">

            <label for="cnpj">Cnpj:</label>
            <input required type="text" name="cnpj" id="cnpj" value="<?php echo $lista['cnpj'];?>">

            <label for="departamento">Divisão ou Departamento:</label>
            <input required type="text" name="departamento" id="departamento" value="<?php echo $lista['departamento'];?>">

            <label for="emailempresa">Email da empresa:</label>
            <input required type="email" name="emailempresa" id="emailempresa" value="<?php echo $lista['emailempresa'];?>">
            
            <label for="enderecoempresa">Endereço empresa:</label>
            <input required type="text" name="enderecoempresa" id="enderecoempresa" placeholder="Rua / n°" value="<?php echo $lista['enderecoempresa'];?>">

            <label for="bairroempresa">Bairro:</label>
            <input required type="text" name="bairroempresa" id="bairroempresa"value="<?php echo $lista['bairroempresa'];?>">

            <label for="telefoneempresa">Telefone da empresa:</label>
            <input required type="text" name="telefoneempresa" id="telefoneempresa"value="<?php echo $lista['telefoneempresa'];?>">

            <label for="cepempresa">CEP da empresa:</label>
            <input required type="text" name="cepempresa" id="cepempresa"value="<?php echo $lista['cepempresa'];?>">

            <label for="cidadeempresa">Cidade da empresa:</label>
            <input required type="text" name="cidadeempresa" id="cidadeempresa" value="<?php echo $lista['cidadeempresa']; ?>">
            <label for="estadoempresa">Estado da empresa:</label>

            <select id="estadoempresa" name="estadoempresa" >
                <option value="AC" <?php if ($lista['estadoempresa'] == "AC"){echo "selected";}?>>Acre</option>
                <option value="AL" <?php if ($lista['estadoempresa'] == "AL"){echo "selected";}?>>Alagoas</option>
                <option value="AP" <?php if ($lista['estadoempresa'] == "AP"){echo "selected";}?>>Amapá</option>
                <option value="AM" <?php if ($lista['estadoempresa'] == "AM"){echo "selected";}?>>Amazonas</option>
                <option value="BA" <?php if ($lista['estadoempresa'] == "BA"){echo "selected";}?>>Bahia</option>
                <option value="CE" <?php if ($lista['estadoempresa'] == "CE"){echo "selected";}?>>Ceará</option>
                <option value="DF" <?php if ($lista['estadoempresa'] == "DF"){echo "selected";}?>>Distrito Federal</option>
                <option value="ES" <?php if ($lista['estadoempresa'] == "ES"){echo "selected";}?>>Espírito Santo</option>
                <option value="GO" <?php if ($lista['estadoempresa'] == "GO"){echo "selected";}?>>Goiás</option>
                <option value="MA" <?php if ($lista['estadoempresa'] == "MA"){echo "selected";}?>>Maranhão</option>
                <option value="MT" <?php if ($lista['estadoempresa'] == "MT"){echo "selected";}?>>Mato Grosso</option>
                <option value="MS" <?php if ($lista['estadoempresa'] == "MS"){echo "selected";}?>>Mato Grosso do Sul</option>
                <option value="MG" <?php if ($lista['estadoempresa'] == "MG"){echo "selected";}?>>Minas Gerais</option>
                <option value="PA" <?php if ($lista['estadoempresa'] == "PA"){echo "selected";}?>>Pará</option>
                <option value="PB" <?php if ($lista['estadoempresa'] == "PB"){echo "selected";}?>>Paraíba</option>
                <option value="PR" <?php if ($lista['estadoempresa'] == "PR"){echo "selected";}?>>Paraná</option>
                <option value="PE" <?php if ($lista['estadoempresa'] == "PE"){echo "selected";}?>>Pernambuco</option>
                <option value="PI" <?php if ($lista['estadoempresa'] == "PI"){echo "selected";}?>>Piauí</option>
                <option value="RJ" <?php if ($lista['estadoempresa'] == "RJ"){echo "selected";}?>>Rio de Janeiro</option>
                <option value="RN" <?php if ($lista['estadoempresa'] == "RN"){echo "selected";}?>>Rio Grande do Norte</option>
                <option value="RS" <?php if ($lista['estadoempresa'] == "RS"){echo "selected";}?>>Rio Grande do Sul</option>
                <option value="RO" <?php if ($lista['estadoempresa'] == "RO"){echo "selected";}?>>Rondônia</option>
                <option value="RR" <?php if ($lista['estadoempresa'] == "RR"){echo "selected";}?>>Roraima</option>
                <option value="SC" <?php if ($lista['estadoempresa'] == "SC"){echo "selected";}?>>Santa Catarina</option>
                <option value="SP" <?php if ($lista['estadoempresa'] == "SP"){echo "selected";}?>>São Paulo</option>
                <option value="SE" <?php if ($lista['estadoempresa'] == "SE"){echo "selected";}?>>Sergipe</option>
                <option value="TO" <?php if ($lista['estadoempresa'] == "TO"){echo "selected";}?>>Tocantins</option>
            </select>
            
            <label for="nomerepresentante">Nome representante:</label>
            <input required type="text" name="nomerepresentante" id="nomerepresentante" value="<?php echo $lista['nomerepresentante'];?>">

            <label for="representantecargo">Cargo do representante:</label>
            <input required type="text" name="representantecargo" id="representantecargo" value="<?php echo $lista['representantecargo'];?>">

            <label for="cpfrepresentante">CPF do representante:</label>
            <input required type="text" name="cpfrepresentante" id="cpfrepresentante" value="<?php echo $lista['cpfrepresentante'];?>">

            <label for="telefonerepresentante">Telefone do representante:</label>
            <input required type="tel" name="telefonerepresentante" id="telefonerepresentante" value="<?php echo $lista['telefonerepresentante'];?>">
        </div>

        <div class="aluno">
            <label for="ra">R.A:</label>
            <input required type="text" name="ra" id="ra" value="<?php echo $lista['ra'];?>">
        
            <label for="semestre">Semestre:</label>
            <input required type="number" name="semestre" id="semestre" value="<?php echo $lista['semestre'];?>">

            <label for="nomeestagiario">Nome do estagiário:</label>
            <input required type="text" name="nomeestagiario" id="nomeestagiario" value="<?php echo $lista['nomeestagiario'];?>">
            
            <label for="rgestagiario">RG do estagiário:</label>
            <input required type="text" name="rgestagiario" id="rgestagiario" value="<?php echo $lista['rgestagiario'];?>">
            
            <label for="enderecoestagiario">Endereço do estagiário:</label>
            <input required type="text" name="enderecoestagiario" id="enderecoestagiario" placeholder="Rua / n°" value="<?php echo $lista['enderecoestagiario'];?>">
            
            <label for="cidadeestagiario">Cidade do estagiário:</label>
            <input required type="text" name="cidadeestagiario" id="cidadeestagiario" value="<?php echo $lista['cidadeestagiario'];?>">

            <label for="bairro">Bairro:</label>
            <input required type="text" name="estagiariobairro" id="estagiariobairro" value="<?php echo $lista['estagiariobairro'];?>">

            <label for="estagiariocep">CEP</label>
            <input required type="text" name="estagiariocep" id="estagiariocep" value="<?php echo $lista['estagiariocep'];?>">

            <label for="estagiariotelefone">Telefone:</label>
            <input required type="tel" name="estagiariotelefone" id="estagiariotelefone" value="<?php echo $lista['estagiariotelefone'];?>">

            <label for="estagiarioemail">Email do estagiário:</label>
            <input required type="email" name="estagiarioemail" id="estagiarioemail" value="<?php echo $lista['estagiarioemail'];?>">

            <label for="estado">Estado:</label>
            <select id="estado" name="estado">
                <option value="AC" <?php if ($lista['estado'] == "AC"){echo "selected";}?>>Acre</option>
                <option value="AL" <?php if ($lista['estado'] == "AL"){echo "selected";}?>>Alagoas</option>
                <option value="AP" <?php if ($lista['estado'] == "AP"){echo "selected";}?>>Amapá</option>
                <option value="AM" <?php if ($lista['estado'] == "AM"){echo "selected";}?>>Amazonas</option>
                <option value="BA" <?php if ($lista['estado'] == "BA"){echo "selected";}?>>Bahia</option>
                <option value="CE" <?php if ($lista['estado'] == "CE"){echo "selected";}?>>Ceará</option>
                <option value="DF" <?php if ($lista['estado'] == "DF"){echo "selected";}?>>Distrito Federal</option>
                <option value="ES" <?php if ($lista['estado'] == "ES"){echo "selected";}?>>Espírito Santo</option>
                <option value="GO" <?php if ($lista['estado'] == "GO"){echo "selected";}?>>Goiás</option>
                <option value="MA" <?php if ($lista['estado'] == "MA"){echo "selected";}?>>Maranhão</option>
                <option value="MT" <?php if ($lista['estado'] == "MT"){echo "selected";}?>>Mato Grosso</option>
                <option value="MS" <?php if ($lista['estado'] == "MS"){echo "selected";}?>>Mato Grosso do Sul</option>
                <option value="MG" <?php if ($lista['estado'] == "MG"){echo "selected";}?>>Minas Gerais</option>
                <option value="PA" <?php if ($lista['estado'] == "PA"){echo "selected";}?>>Pará</option>
                <option value="PB" <?php if ($lista['estado'] == "PB"){echo "selected";}?>>Paraíba</option>
                <option value="PR" <?php if ($lista['estado'] == "PR"){echo "selected";}?>>Paraná</option>
                <option value="PE" <?php if ($lista['estado'] == "PE"){echo "selected";}?>>Pernambuco</option>
                <option value="PI" <?php if ($lista['estado'] == "PI"){echo "selected";}?>>Piauí</option>
                <option value="RJ" <?php if ($lista['estado'] == "RJ"){echo "selected";}?>>Rio de Janeiro</option>
                <option value="RN" <?php if ($lista['estado'] == "RN"){echo "selected";}?>>Rio Grande do Norte</option>
                <option value="RS" <?php if ($lista['estado'] == "RS"){echo "selected";}?>>Rio Grande do Sul</option>
                <option value="RO" <?php if ($lista['estado'] == "RO"){echo "selected";}?>>Rondônia</option>
                <option value="RR" <?php if ($lista['estado'] == "RR"){echo "selected";}?>>Roraima</option>
                <option value="SC" <?php if ($lista['estado'] == "SC"){echo "selected";}?>>Santa Catarina</option>
                <option value="SP" <?php if ($lista['estado'] == "SP"){echo "selected";}?>>São Paulo</option>
                <option value="SE" <?php if ($lista['estado'] == "SE"){echo "selected";}?>>Sergipe</option>
                <option value="TO" <?php if ($lista['estado'] == "TO"){echo "selected";}?>>Tocantins</option>
            </select>
        </div>
        
        <div class="estagio">
            <label for="horarioentrada">Horário entrada:</label>
            <input required type="time" name="horarioentrada" id="horarioentrada" value="<?php echo $lista['horarioentrada'];?>">
            
            <label for="horariosaida">Horário saida:</label>
            <input required type="time" name="horariosaida" id="horariosaida" value="<?php echo $lista['horariosaida'];?>">

            <label for="entradarefeicao">Entrada do horário de refeição:</label>
            <input required type="time" name="entradarefeicao" id="entradarefeicao" value="<?php echo $lista['entradarefeicao'];?>">

            <label for="saidarefeicao">Saida do horário de refeição:</label>
            <input required type="time" name="saidarefeicao" id="saidarefeicao" value="<?php echo $lista['saidarefeicao'];?>">

            <label for="horassemanais">Horas totais semanais:</label>
            <input required type="number" name="horassemanais" id="horassemanais" value="<?php echo $lista['horassemanais'];?>">

            <label for="comeco">Data do começo do estágio:</label>
            <input required type="date" name="comeco" id="comeco"  value="<?php echo $lista['comeco'];?>">
            
            <label for="fim">Data do fim do estágio:</label>
            <input required type="date" name="fim" id="fim"  value="<?php echo $lista['fim'];?>">

            <label for="salario">Salário:</label>
            <input required type="text" name="salario" id="salario" value="<?php echo $lista['salario'];?>">

            <label for="salarioextenso">Digite o salário por extenso</label>
            <input required type="text" name="salarioextenso" id="salarioextenso" placeholder="ex: quinhentos e um reais e trinta centavos" value="<?php echo $lista['salarioextenso'];?>">
        </div>
        
        <div class="seguro">
            <label for="numeroapolice">Número da apólice:</label>
            <input required type="text" name="numeroapolice" id="numeroapolice" value="<?php echo $lista['numeroapolice'];?>">

            <label for="nomeseguradora">Nome da seguradora:</label>
            <input required type="text" name="nomeseguradora" id="nomeseguradora" value="<?php echo $lista['nomeseguradora'];?>">
        </div>
        ...
        <div class="atividades">
            ...
            <textarea name="periodo" id="periodo"> <?php echo $lista['periodo'];?></textarea></div>
        ...
        function pegarValoresFormulario() {
            ...
            let html = `<!DOCTYPE html>
                ...
                text-align: center;}
                    ...
                    font-size: 11pt;
                margin:19px}
                .rodape{display: flex;text-align: center;flex-direction: column;}
                ...
                <body>
                    <div class="linhacabecalho">
                        <div class="nd">
                <img src="../marcadagua1.png" alt="" id="minhaimagem1">
                <img src="../marcadagua2.png" alt="" id="minhaimagem2"></div>
                ...
                <div class="linhacabecalho">
                    <div class="nd">
                <img src="../marcadagua1.png" alt="">
                <img src="../marcadagua2.png" alt=""></div>
                <h1>Fatec de Itapira “Ogari de Castro Pacheco”</h1>
                <h1 style="font-family: Verdana, Geneva, Tahoma, sans-serif;font-size: 9pt;color: black;margin-bottom: 30px;">Curso Superior de Tecnologia em Desenvolvimento de Software Multiplataforma</h1>
                </div>
                ...
                <p><strong>xCLÁUSULA DÉCIMA</strong>. Assim, materializado e caracterizado, o presente Estágio, segundo a legislação, não acarretará vínculo empregatício de qualquer natureza entre o (a) Estagiário (a) e a Concedente, nos termos do que dispõem o Artigo 12º da Lei nº 11.788/08. </p> 
                <p><strong>xCLÁUSULA DÉCIMA PRIMEIRA</strong>. As partes elegem o Foro da Comarca de Itapira-SP, com expressa renúncia de outro, por mais privilegiado que seja para dirimir qualquer questão emergente do presente Termo de Compromisso.</p>
                ...
                <div class="espaco" style="margin-top:300px"></div>
                <div class="rodape">
                    <h2>www.fatecitapira.edu.br</h2>
                    <h3>Rua Tereza Lera Paoleti, 590  •  Jardim Bela Vista  •  13.974-080  •  Itapira  •  SP  •  Tel.: (19) 3843.1996</h3>
                </div>
                ...
                <div class="cargosup">Cargo do supervisor:${representantecargo}<p style="margin-left: 38%;font-family: 'Times New Roman', Times, serif;font-size: 16px;">Telefone do supervisor:${telefonerepresentante}</p></div>
                ...
                <div class="idenestagio" id="idenestagio">
                    ...
                    <div class="real"><p style="margin-left:0;margin-top:-20px;font-size:14px;">Período real de execução:</p><p style="margin-left: -140px;font-size:18px">Início:___/___/____</p><p style="font-size: 18px;">Término:___/___/____</p></div>
